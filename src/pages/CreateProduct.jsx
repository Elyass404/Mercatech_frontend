...
export default function CreateProduct() {
    ...
    const handleSubmit = async (e) => {
        ...
        // Prepare the data to match your Spring Boot ProductRequest DTO
        ...
        try {
            ...
            // If successful, redirect back to the product list
            navigate('/products');
        } catch (err) {
            console.error("Erreur lors de la création:", err);
            // Check if backend sent a specific validation message
            if (err.response && err.response.data) {
                setError("Erreur: Vérifiez les données saisies."); 
            } else {
        ...
        <div className="min-h-screen bg-gray-100">
            ...
            <div className="p-8 max-w-2xl mx-auto">
                <div className="flex justify-between items-center mb-6">
                    <h1 className="text-3xl font-bold text-gray-800">Nouveau Produit</h1>
                ...
                <div className="bg-white p-8 rounded-lg shadow-md">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div className="flex justify-end pt-4">
                            <button
                                type="submit"
                                className="bg-green-600 text-white font-bold py-2 px-6 rounded hover:bg-green-700 transition duration-200"
                            >
